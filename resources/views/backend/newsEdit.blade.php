        ...
        <div>
            <form method="POST" action="/news/edit/{{$news->id}}" enctype="multipart/form-data">
                ...
                <div class="form-group offset-md-2 offset-ld-2 offset-0 col-md-8 col-lg-8 col-12">
                    ...
                    <input class="form-control" type="text" id="fullname" value="{{$news->title}}" name="title">
                </div>
                <div class="form-group">
                    <label for="title">Content</label>
                    <textarea class="form-control" name="area3" style="width: 100%; height : 500px;">{{$news->content}}</textarea>
                </div><div class="form-group offset-md-2 offset-ld-2 offset-0 col-md-8 col-lg-8 col-12">
                    <label for="fullname">First Name</label>
                    <input class="form-control" type="text" id="name" name="name" value="{{$news->name}}">
                </div>
                <div class="form-group offset-md-2 offset-ld-2 offset-0 col-md-8 col-lg-8 col-12">
                    <label for="fullname">Surname</label>
                    <input class="form-control" type="text" id="surname" name="surname" value="{{$news->surname}}">
                </div>
                <div class="form-group offset-md-2 offset-ld-2 offset-0 col-md-8 col-lg-8 col-12">
